...
print("Fetching Y11S2 operator stats...")
params = {
    "type": "operatorStats",
...
if resp.status_code == 200:
    ...
    print(f"Parsed {len(parsed_ops)} operators for Y11S2.")
    with open("data/raw/WamaiDoingThis_y11s2_ops.json", "w", encoding="utf-8") as f:
        json.dump(parsed_ops, f, indent=2, ensure_ascii=False)
    print("Saved to data/raw/WamaiDoingThis_y11s2_ops.json")
else:
    print(f"Error fetching Y11S2 operators: {resp.status_code} - {resp.text}")
